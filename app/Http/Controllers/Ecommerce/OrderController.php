...
class OrderController extends Controller
{
    ...
    public function view($invoice)
    {
        ...
        return redirect(route('customer.orders'))->with('error', 'You arent Allowed to Access this Order');
    ...
    public function destroy($id)
    {
        ...
        return redirect(route('customer.orders'))->with('success', 'Your Order was Deleted');
    }
    ...
    public function storePayment(Request $request)
    {
        ...
        try {
            ...
            if ($order->subtotal != $request->amount)
                return redirect()->back()->with('error', 'Make Sure Your Payment Must Equal To Bill');
            ...
            return redirect()->back()->with('error', 'Failed to Upload Your Confirmation');
